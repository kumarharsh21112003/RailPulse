...
export function LiveStationBoard({ code }: { code: string }) {
  ...
  if (error || (data && !data.success)) {
    return (
      <div className="flex flex-col items-center justify-center p-10 mt-6 text-rose-500 glass-panel rounded-3xl">
